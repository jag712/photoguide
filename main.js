...
async function generateQuiz(quizCount) {
    ...
    if (!parsed || !Array.isArray(parsed.questions) || parsed.questions.length === 0) {
        parsed = createFallbackQuiz(pool, baseCount);
    }
