        ...
        html = `
          <div class="max-w-4xl mx-auto">
            <header class="text-center mb-8">
              ...
              <p class="text-gray-600 mt-2">sRGB와 Display P3 색 공간 비교</p>
            </header>
            <section class="mb-8">
              <p class="mb-4 text-gray-700">같은 이미지라도 색 공간에 따라 다르게 보일 수 있습니다. 아래 예시는 sRGB와 Display P3 색 공간으로 표현된 동일한 그래픽을 비교합니다.</p>
              <div class="flex flex-col md:flex-row items-center justify-center gap-4">
                <figure class="text-center">
                  <svg viewBox="0 0 100 100" class="w-48 h-48 rounded-md border">
                    <rect width="100" height="100" fill="rgb(255,0,0)"></rect>
                    <polygon points="50,20 61,39 82,39 65,54 71,75 50,63 29,75 35,54 18,39 39,39" fill="rgba(0,0,0,0.2)"></polygon>
                  </svg>
                  <figcaption class="mt-2 text-sm text-gray-600">sRGB</figcaption>
                </figure>
                <figure class="text-center">
                  <svg viewBox="0 0 100 100" class="w-48 h-48 rounded-md border">
                    <rect width="100" height="100" fill="color(display-p3 1 0 0)"></rect>
                    <polygon points="50,20 61,39 82,39 65,54 71,75 50,63 29,75 35,54 18,39 39,39" fill="rgba(0,0,0,0.2)"></polygon>
                  </svg>
                  <figcaption class="mt-2 text-sm text-gray-600">Display P3</figcaption>
                </figure>
              </div>
            </section>
          </div>
