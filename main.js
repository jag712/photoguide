    ...
    fullStop: [
      {
        label: "f/1",
        value: 16,
        desc: "빛을 최대로 수용합니다. 극도로 얕은 피사계 심도로 특정 지점 외 모든 것을 흐리게 만들어 몽환적, 예술적 표현에 사용됩니다.",
      },
      {
        label: "f/1.4",
        value: 15,
        desc: "매우 밝은 조리개 값으로, 어두운 환경에서도 셔터 속도를 확보하기 용이합니다. 배경을 크게 흐려 피사체를 극적으로 분리시킵니다.",
      },
      {
        label: "f/2",
        value: 14,
        desc: "실내 인물 촬영의 표준. 배경 흐림이 아름답고, f/1.4보다 초점 맞는 범위가 넓어 안정적인 촬영이 가능합니다.",
      },
      {
        label: "f/2.8",
        value: 13,
        desc: "고급 줌 렌즈의 상징적인 밝기. 배경을 적절히 흐리면서도 피사체의 입체감을 살려주는 실용적인 심도를 제공합니다.",
      },
      {
        label: "f/4",
        value: 12,
        desc: "주광(Daylight)에서 풍경과 인물을 함께 담을 때 선명도와 심도를 모두 만족시키는 균형 잡힌 값입니다.",
      },
      {
        label: "f/5.6",
        value: 11,
        desc: "2인 이상의 단체 사진에서 모든 인물의 얼굴에 초점을 맞출 수 있는 피사계 심도가 확보되기 시작합니다.",
      },
      {
        label: "f/8",
        value: 10,
        desc: "풍경 사진의 교과서. 렌즈의 광학적 성능이 최상에 가까워지며, 화면 전체에 걸쳐 높은 선명도를 보여줍니다.",
      },
      {
        label: "f/11",
        value: 9,
        desc: "매우 깊은 피사계 심도(팬 포커스)를 확보하여 사진의 전경부터 원경까지 모두 선명하게 표현하고자 할 때 사용됩니다.",
      },
      {
        label: "f/16",
        value: 8,
        desc: "심도는 더욱 깊어지지만, 빛의 회절(Diffraction) 현상이 시작되어 이미지의 선명도가 미세하게 저하될 수 있습니다.",
      },
      {
        label: "f/22",
        value: 7,
        desc: "장노출 촬영이나 접사(Macro) 촬영 등 특수한 목적을 위해 극단적으로 깊은 심도가 필요할 때 선택합니다.",
      },
      {
        label: "f/32",
        value: 6,
        desc: "회절로 인한 화질 저하가 뚜렷해집니다. 대형 카메라나 과학 사진 분야에서 사용되며, 강한 빛 갈라짐 효과를 얻을 수 있습니다.",
      },
      {
        label: "f/45",
        value: 5,
        desc: "모든 것이 초점에 맞는 듯한 극한의 심도를 제공하지만, 선명도는 크게 희생됩니다. 특수 목적용 조리개 값입니다.",
      },
      {
        label: "f/64",
        value: 4,
        desc: "대형 포맷 카메라에서 사용되는 값으로, 일반적인 촬영에서는 거의 사용되지 않으며 회절 현상이 매우 심합니다.",
      },
      {
        label: "f/90",
        value: 3,
        desc: "과학적, 기술적 촬영을 위한 값입니다. 극도의 심도 표현이 가능하나 일반 사진에서는 화질 저하가 극심합니다.",
      },
      {
        label: "f/128",
        value: 2,
        desc: "핀홀 카메라와 유사한 효과를 내는 조리개 값으로, 사진이라기보다는 빛의 기록에 가까운 결과물을 만듭니다.",
      },
    ],
    thirdStop: [
      {
        label: "f/1.0",
        value: 16,
        desc: "'야간 렌즈'의 시작. 극도로 얕은 심도로 몽환적이고 예술적인 사진을 만들며, 아주 적은 빛으로도 촬영이 가능합니다.",
      },
      {
        label: "f/1.1",
        value: 15.66,
        desc: "f/1.0의 극단적인 심도를 미세하게 깊게 만들어 초점의 안정성을 조금 더 확보합니다.",
      },
      {
        label: "f/1.2",
        value: 15.33,
        desc: "전문 인물 사진 작가들이 선호하는 값. 피사체의 눈에만 초점을 맞추고 나머지를 부드럽게 흐릴 수 있습니다.",
      },
      {
        label: "f/1.4",
        value: 15,
        desc: "'꿈의 렌즈'라 불리는 밝기. 배경을 매우 부드럽게 압축하여 피사체를 극적으로 돋보이게 만듭니다.",
      },
      {
        label: "f/1.6",
        value: 14.66,
        desc: "f/1.4의 배경 흐림을 유지하면서 초점 범위를 살짝 넓혀 더 안정적인 결과물을 만들어냅니다.",
      },
      {
        label: "f/1.8",
        value: 14.33,
        desc: "'여친 렌즈'의 표준. 뛰어난 가성비로 아름다운 배경 흐림 효과를 누구나 쉽게 연출할 수 있습니다.",
      },
      {
        label: "f/2.0",
        value: 14,
        desc: "어두운 실내나 카페에서 인물 촬영 시 셔터 속도 확보에 유리하며, 자연스러운 배경 흐림을 보여줍니다.",
      },
      {
        label: "f/2.2",
        value: 13.66,
        desc: "f/2.0보다 심도를 약간 더 확보하여 피사체의 코와 귀가 모두 선명하게 나올 확률을 높여줍니다.",
      },
      {
        label: "f/2.5",
        value: 13.33,
        desc: "배경을 적당히 흐리면서 피사체의 윤곽은 선명하게 유지하여 안정적인 인물 사진에 적합합니다.",
      },
      {
        label: "f/2.8",
        value: 13,
        desc: "줌 렌즈의 '축복'. 전천후 스냅 및 행사 촬영에 가장 실용적인 밝기와 심도를 제공합니다.",
      },
      {
        label: "f/3.2",
        value: 12.66,
        desc: "f/2.8의 실용성에 심도를 더해, 여러 사람이 있는 스냅 사진에서 초점 정확도를 높입니다.",
      },
      {
        label: "f/3.5",
        value: 12.33,
        desc: "보급형 줌렌즈의 시작. 주간 야외 촬영에서 충분한 빛을 확보하며 배경도 어느 정도 정리됩니다.",
      },
      {
        label: "f/4.0",
        value: 12,
        desc: "한낮의 야외에서 선명하고 쨍한 결과물을 원할 때. 풍경과 인물을 함께 담는 여행 사진에 좋습니다.",
      },
      {
        label: "f/4.5",
        value: 11.66,
        desc: "f/4.0의 선명도를 유지하면서 더 넓은 영역에 초점을 맞추고 싶을 때 미세 조정하는 값입니다.",
      },
      {
        label: "f/5.0",
        value: 11.33,
        desc: "피사체와 배경 모두 어느 정도의 선명도를 유지하기 시작하며, 전신 인물 사진에 활용됩니다.",
      },
      {
        label: "f/5.6",
        value: 11,
        desc: "두 명 이상의 인물 사진, 단체 사진에서 모두의 얼굴에 초점을 맞추기 위한 시작점입니다.",
      },
      {
        label: "f/6.3",
        value: 10.66,
        desc: "단체 사진에서 앞줄과 뒷줄의 인물 모두에게 선명한 초점을 맞추기 위해 심도를 더 확보합니다.",
      },
      {
        label: "f/7.1",
        value: 10.33,
        desc: "풍경 사진에서 f/8.0에 가까운 선명도를 얻으면서, 셔터 속도를 조금 더 확보하고 싶을 때 사용합니다.",
      },
      {
        label: "f/8.0",
        value: 10,
        desc: "풍경 사진의 교과서. 화면 전체에 걸쳐 가장 선명하고 깊은 심도의 이미지를 만들어냅니다.",
      },
      {
        label: "f/9.0",
        value: 9.66,
        desc: "f/8.0보다 심도를 더 깊게 하여, 전경의 꽃부터 원경의 산까지 모두 선명하게 표현합니다.",
      },
      {
        label: "f/10",
        value: 9.33,
        desc: "더 깊은 심도가 필요할 때 사용하며, 건축 사진이나 도시 풍경 촬영에 적합합니다.",
      },
      {
        label: "f/11",
        value: 9,
        desc: "렌즈가 가진 최고의 해상력을 보여주는 구간. 피사계 심도를 극대화하여 팬 포커스 촬영에 유리합니다.",
      },
      {
        label: "f/13",
        value: 8.66,
        desc: "f/11의 선명도를 최대한 유지하면서 빛 갈라짐 효과를 더 강하게 만들고 싶을 때 사용합니다.",
      },
      {
        label: "f/14",
        value: 8.33,
        desc: "빛 갈라짐 효과가 나타나기 시작합니다. 야경 촬영 시 가로등을 아름다운 별처럼 표현할 수 있습니다.",
      },
      {
        label: "f/16",
        value: 8,
        desc: "심도는 매우 깊어지지만, 빛의 회절 현상으로 화질이 미세하게 저하될 수 있습니다. 장노출 촬영에 활용됩니다.",
      },
      {
        label: "f/18",
        value: 7.66,
        desc: "회절 현상에 유의해야 하지만, 태양처럼 강한 광원을 담을 때 더 선명한 빛 갈라짐을 만들 수 있습니다.",
      },
      {
        label: "f/20",
        value: 7.33,
        desc: "대부분 렌즈에서 화질 저하가 눈에 띄게 나타날 수 있어 특수한 목적 외에는 잘 사용하지 않습니다.",
      },
      {
        label: "f/22",
        value: 7,
        desc: "최소 조리개. 심도를 최대한 깊게 해야 하는 접사(Macro) 사진이나 특수 효과를 위해 사용됩니다.",
      },
    ],
  },
  shutter: {
    fullStop: [
      {
        label: '30"',
        value: 18,
        desc: "삼각대 필수, 자동차 궤적이나 별 궤적 촬영에 사용됩니다.",
      },
      {
        label: '15"',
        value: 17,
        desc: "긴 시간 노출로 구름이나 물의 흐름을 부드럽게 표현합니다.",
      },
      {
        label: '8"',
        value: 16,
        desc: "사람의 움직임이 잔상으로 남아 신비로운 느낌을 줍니다.",
      },
      {
        label: '4"',
        value: 15,
        desc: "야경 촬영 시 자동차 궤적을 짧게 담을 수 있습니다.",
      },
      {
        label: '2"',
        value: 14,
        desc: "폭포수나 파도의 움직임을 부드럽게 표현하기 시작합니다.",
      },
      {
        label: '1"',
        value: 13,
        desc: "삼각대 없이는 사진이 심하게 흔들리며 빛의 궤적을 담습니다.",
      },
      {
        label: "1/2s",
        value: 12,
        desc: "의도적인 패닝샷으로 역동적인 흔들림을 표현할 수 있습니다.",
      },
      {
        label: "1/4s",
        value: 11,
        desc: "손떨림 방지 기능이 있어도 핸드헬드 촬영이 매우 어렵습니다.",
      },
      {
        label: "1/8s",
        value: 10,
        desc: "느리게 걷는 사람의 움직임에 약간의 블러가 생깁니다.",
      },
      {
        label: "1/15s",
        value: 9,
        desc: "핸드헬드 촬영 시 안정적인 자세와 호흡 조절이 필요합니다.",
      },
      {
        label: "1/30s",
        value: 8,
        desc: "광각 렌즈 사용 시 핸드헬드 촬영의 마지노선입니다.",
      },
      {
        label: "1/60s",
        value: 7,
        desc: "일상적인 스냅 촬영 시 최소한으로 권장되는 속도입니다.",
      },
      {
        label: "1/125s",
        value: 6,
        desc: "걷는 사람 정도의 움직임을 흔들림 없이 촬영할 수 있습니다.",
      },
      {
        label: "1/250s",
        value: 5,
        desc: "가볍게 뛰는 아이나 반려동물을 선명하게 포착합니다.",
      },
      {
        label: "1/500s",
        value: 4,
        desc: "스포츠 경기 등 빠른 움직임을 선명하게 정지시키기 시작합니다.",
      },
      {
        label: "1/1000s",
        value: 3,
        desc: "빠르게 달리는 자동차나 운동선수를 선명하게 포착합니다.",
      },
      {
        label: "1/2000s",
        value: 2,
        desc: "날아가는 새의 날갯짓을 정지시킬 수 있는 매우 빠른 속도입니다.",
      },
      {
        label: "1/4000s",
        value: 1,
        desc: "프로펠러나 헬리콥터 날개를 정지시키는 전문가용 속도입니다.",
      },
      {
        label: "1/8000s",
        value: 0,
        desc: "물방울이 터지는 순간 등 찰나를 포착하는 초고속 셔터입니다.",
      },
    ],
    thirdStop: [
      {
      ...
      },
      {
        label: "1/1.3s",
        value: 12.66,
        desc: "장노출 패닝샷에서 배경의 흐름을 좀 더 부드럽게 표현합니다.",
      },
      {
        label: "1/1.6s",
        value: 12.33,
        desc: "물의 흐름이나 움직임을 살짝 부드럽게 만들며 역동성을 조절합니다.",
      },
      {
        label: "1/2s",
        value: 12,
      ...
      },
      {
        label: "1/2.5s",
        value: 11.66,
        desc: "패닝샷 촬영 시 배경의 흐림 정도를 미세하게 조절합니다.",
      },
      {
        label: "1/3s",
        value: 11.33,
      ...
      },
      {
        label: "1/4s",
        value: 11,
        desc: "느리게 움직이는 피사체에 블러 효과를 주기 좋습니다.",
      },
      {
        label: "1/5s",
        value: 10.66,
        desc: "걷는 사람의 움직임을 의도적으로 흐리게 표현하여 속도감을 나타냅니다.",
      },
      {
        label: "1/6s",
        value: 10.33,
        desc: "안정적인 자세와 호흡 조절이 필요합니다.",
      },
      {
        label: "1/8s",
        value: 10,
      ...
      },
      {
        label: "1/10s",
        value: 9.66,
        desc: "광각 렌즈로 핸드헬드 촬영 시 흔들림을 최소화하며 안정성을 높입니다.",
      },
      {
        label: "1/13s",
        value: 9.33,
        desc: "핸드헬드 촬영 시 안정적인 자세가 필요합니다.",
      },
      {
        label: "1/15s",
        value: 9,
        desc: "여전히 핸드헬드 촬영 시 주의가 필요한 속도입니다.",
      },
      {
        label: "1/20s",
        value: 8.66,
        desc: "정적인 피사체를 핸드헬드로 촬영할 때 흔들림을 방지하는 안정적인 속도입니다.",
      },
      {
        label: "1/25s",
        value: 8.33,
      ...
      },
      {
        label: "1/30s",
        value: 8,
        desc: "표준 렌즈(50mm) 촬영 시 흔들림이 발생할 수 있는 최소 권장 속도입니다.",
      },
      {
        label: "1/40s",
        value: 7.66,
        desc: "표준 렌즈로 정적인 피사체를 안정적으로 촬영할 수 있습니다.",
      },
      {
        label: "1/50s",
        value: 7.33,
        desc: "일상적인 실내 스냅에서 흔들림을 방지하기 위한 실용적인 속도입니다.",
      },
      {
        label: "1/60s",
        value: 7,
      ...
      },
      {
        label: "1/80s",
        value: 6.66,
        desc: "조금 더 활동적인 아이들의 움직임을 흔들림 없이 포착하기 시작합니다.",
      },
      {
        label: "1/100s",
        value: 6.33,
        desc: "걷는 사람 정도의 움직임을 선명하고 안정적으로 촬영할 수 있습니다.",
      },
      {
        label: "1/125s",
        value: 6,
        desc: "일반적인 움직임을 선명하게 포착하는 표준 속도입니다.",
      },
      {
        label: "1/160s",
        value: 5.66,
        desc: "가볍게 뛰는 아이나 반려동물 촬영 시 실패 확률을 줄여줍니다.",
      },
      {
        label: "1/200s",
        value: 5.33,
        desc: "움직임이 불규칙한 피사체를 선명하게 포착하기에 좋습니다.",
      },
      {
        label: "1/250s",
        value: 5,
        desc: "대부분의 일상적인 움직임을 정지시킬 수 있습니다.",
      },
      {
        label: "1/320s",
        value: 4.66,
        desc: "자전거 타는 아이 등, 조금 더 빠른 움직임을 선명하게 담아냅니다.",
      },
      {
        label: "1/400s",
        value: 4.33,
      ...
      },
      {
        label: "1/500s",
        value: 4,
        desc: "빠른 움직임을 포착하기에 매우 안정적인 속도입니다.",
      },
      {
        label: "1/640s",
        value: 3.66,
        desc: "달리는 자동차나 빠르게 움직이는 운동선수를 더 확실하게 정지시킵니다.",
      },
      {
        label: "1/800s",
        value: 3.33,
        desc: "테니스나 배드민턴처럼 빠른 공의 움직임을 포착하기 시작합니다.",
      },
      {
        label: "1/1000s",
        value: 3,
        desc: "순간적인 동작을 놓치지 않고 선명하게 담아냅니다.",
      },
    ],
  },
};
...
const interviewQuizBtn = document.getElementById("interviewQuizBtn");
...
let score = 0;
let quizTimer; // 퀴즈 타이머를 관리할 전역 변수
let timerStartTime;
let timeRemaining;
let isTimerPaused = false;
let quizTimeLimit;

let interviewQuizData = null;
...
function createCalendar(year, month, events = {}) {
  ...
  for (let day = 1; day <= daysInMonth; day++) {
    ...
    let eventHtml = dayEvents
      .map(
        (e) =>
          `<div class="text-white p-1 rounded-md ${e.color || "bg-blue-500"} mb-1 truncate" title="${e.title}">${e.title}</div>`,
      )
      .join("");
    let dayClass = "";
...
function showModal() {
  ...
  iconChangeInterval = setInterval(() => {
    ...
    rotatingIcon.innerText = randomIcon;
  }, 1000);
...
function displayQuizQuestion() {
  ...
  modalBody.innerHTML = `
        ...
        <div class="relative pt-1 flex items-center mb-4">
            <div class="overflow-hidden h-2 text-xs flex rounded bg-blue-200 flex-1">
                <div id="quizTimerBar" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500" style="width: 100%;"></div>
            </div>
  ...
  // JavaScript 코드를 HTML 할당 뒤에 작성합니다.
  timeRemaining = quizTimeLimit * 1000;
  timerStartTime = Date.now();
  isTimerPaused = false;

  // DOM이 완전히 로드된 후 애니메이션이 시작되도록 setTimeout을 사용합니다.
  setTimeout(() => {
    const timerBar = document.getElementById("quizTimerBar");
    timerBar.style.transition = `width linear ${quizTimeLimit}s`;
    timerBar.style.width = "0%";
  }, 100);

  // 퀴즈 시간 초과를 처리할 타이머를 시작합니다.
  clearTimeout(quizTimer);
  quizTimer = setTimeout(() => {
    checkQuizAnswer(true);
  }, quizTimeLimit * 1000);
...
// 타이머 일시정지/재생 함수 (수정된 startTimer 함수)
function startTimer() {
  // timeRemaining 변수가 올바르게 설정된 경우에만 타이머 시작
  if (isTimerPaused || !timeRemaining) return;
...
function checkQuizAnswer(isTimeUp = false) {
  ...
  if (isTimeUp) {
    ...
    if (selectedAnswer === correctAnswer) {
      ...
      const explanation =
        allData.find((item) => item.q.includes(correctAnswer))?.a ||
        "관련된 설명을 찾을 수 없습니다.";
...
function renderContent(category, searchTerm = "") {
  ...
  if (category === "home") {
    ...
    if (searchTerm) {
      const jamoSearch =
        typeof Jamo !== "undefined" ? Jamo.jamo(searchTerm.toLowerCase()) : "";
      const allData = Object.values(photographyData).flat();
      itemsToRender = allData.filter(
        (item) =>
          item &&
          item.q &&
          (item.q.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            (jamoSearch &&
              (Jamo.jamo(item.q.toLowerCase()).includes(jamoSearch) ||
                (item.keywords &&
                  Jamo.jamo(item.keywords.toLowerCase()).includes(
                    jamoSearch,
                  ))))),
      );
    } else {
...
searchInput.addEventListener("input", () => {
  ...
  if (searchTerm.length > 0) {
    ...
    const activeOrHomeLink =
      document.querySelector(".nav-item.active") ||
      document.querySelector('[data-category="home"]');
    if (activeOrHomeLink) {
 ...
 * =================================================================
 */
async function generateInterviewQuiz() {
  const activeLink = document.querySelector(".nav-item.active");
  const category = activeLink ? activeLink.dataset.category : "all";
  const categoryName = activeLink ? activeLink.textContent : "전체";
  modalTitle.textContent = `${categoryName} 실전퀴즈`;
  let contentForQuiz = [];
  if (
    ["home", "visualization", "all", "cms"].includes(category) ||
    !photographyData[category]
  ...
  const topics = contentForQuiz
    .sort(() => 0.5 - Math.random())
    .slice(0, 15)
    .map((item) => item.q)
    .join(", ");
  const prompt = `다음 사진학 주제들을 바탕으로 면접형 주관식 퀴즈 3개를 생성해줘: ${topics}. 각 질문과 모범 답안을 {"questions":[{"question":"","answer":""}]} 형식의 JSON으로 반환해줘.`;
  const responseText = await callGemini(prompt, false);
  try {
    interviewQuizData = JSON.parse(responseText);
    if (
      interviewQuizData &&
      Array.isArray(interviewQuizData.questions) &&
      interviewQuizData.questions.length > 0
    ) {
      currentInterviewQuestionIndex = 0;
      interviewScore = 0;
      displayInterviewQuestion();
    } else {
      throw new Error("Invalid interview quiz format received.");
    }
  } catch (e) {
    console.error("Interview quiz parsing error:", e);
    modalBody.innerHTML = `<p class="text-red-500">실전퀴즈를 생성하는 데 실패했습니다.</p>`;
  }
}

function displayInterviewQuestion() {
  const q = interviewQuizData.questions[currentInterviewQuestionIndex];
  modalBody.innerHTML = `
        <div class="mb-4">
            <p class="text-sm text-gray-500">문제 ${
              currentInterviewQuestionIndex + 1
            } / ${interviewQuizData.questions.length}</p>
            <p class="text-lg font-semibold mt-1">${q.question}</p>
        </div>
        <textarea id="interviewAnswer" class="w-full border p-2 rounded mb-4" rows="5" placeholder="답변을 입력하세요..."></textarea>
        <div id="interviewResult" class="mt-2"></div>
        <div class="flex justify-end mt-4">
            <button id="submitInterviewAnswerBtn" class="bg-gray-700 text-white font-bold py-2 px-4 rounded-lg hover:bg-gray-800">제출</button>
        </div>`;
  document
    .getElementById("submitInterviewAnswerBtn")
    .addEventListener("click", evaluateInterviewAnswer);
}

async function evaluateInterviewAnswer() {
  const userAnswer = document.getElementById("interviewAnswer").value.trim();
  if (!userAnswer) return;
  const q = interviewQuizData.questions[currentInterviewQuestionIndex];
  const prompt = `다음은 질문과 모범 답안, 그리고 사용자의 답변입니다.\n질문: ${q.question}\n모범 답안: ${q.answer}\n사용자 답변: ${userAnswer}\n모범 답안과 비교하여 0에서 100 사이의 점수를 주고 간단한 피드백을 제공해줘. {"score": number, "feedback": string} 형식의 JSON으로 응답해줘.`;
  const responseText = await callGemini(prompt, false);
  let result;
  try {
    result = JSON.parse(responseText);
  } catch (e) {
    console.error("Interview quiz evaluation error:", e);
    document.getElementById("interviewResult").innerHTML =
      `<p class="text-red-500">답안을 평가하지 못했습니다.</p>`;
    return;
  }
  const qScore = Number(result.score) || 0;
  interviewScore += qScore;
  document.getElementById("interviewResult").innerHTML =
    `<p class="font-semibold">점수: ${qScore}</p><p>${result.feedback || ""}</p>`;
  const submitBtn = document.getElementById("submitInterviewAnswerBtn");
  submitBtn.classList.add("hidden");
  const nextBtn = document.createElement("button");
  nextBtn.id = "nextInterviewQuestionBtn";
  nextBtn.className =
    "ml-2 bg-gray-700 text-white font-bold py-2 px-4 rounded-lg hover:bg-gray-800";
  nextBtn.textContent =
    currentInterviewQuestionIndex + 1 < interviewQuizData.questions.length
      ? "다음 문제"
      : "결과 보기";
  document.querySelector(".flex.justify-end.mt-4").appendChild(nextBtn);
  nextBtn.addEventListener("click", () => {
    currentInterviewQuestionIndex++;
    if (currentInterviewQuestionIndex < interviewQuizData.questions.length) {
      displayInterviewQuestion();
    } else {
      displayInterviewFinalScore();
    }
  });
}

function displayInterviewFinalScore() {
  const average = Math.round(
    interviewScore / interviewQuizData.questions.length,
  );
  modalBody.innerHTML = `
        <div class="p-6 text-center">
            <h2 class="text-2xl font-bold mb-4">🎉 실전퀴즈 완료! 🎉</h2>
            <p class="text-xl">평균 점수는 <span class="text-blue-600 font-bold">${average}</span>점 입니다.</p>
            <button id="closeInterviewQuizBtn" class="mt-8 bg-gray-700 text-white font-bold py-2 px-6 rounded-lg hover:bg-gray-800">닫기</button>
        </div>`;
  document
    .getElementById("closeInterviewQuizBtn")
  ...
  document.querySelectorAll(".gemini-btn").forEach((btn) => {
    btn.addEventListener("click", async (e) => {
      ...
      if (action === "explain") {
        ...
        prompt = `사진학 개념인 "${question}"에 대해 더 깊이 알고 싶어. 다음 기본 설명을 바탕으로, 관련된 심화 개념, 역사적 배경, 또는 실전 촬영 팁을 포함하여 전문가 수준의 추가 정보를 제공해줘 작가의 경우 대표 사진도 보여줘. 단 800자 내외로. 설명: ${answer}`;
      }
...
interviewQuizBtn.addEventListener("click", generateInterviewQuiz);
